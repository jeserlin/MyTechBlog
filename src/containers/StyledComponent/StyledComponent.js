    ...
    return(
      <div className='container'>
        ...
        <ArticleContent>
          ...
          <ol>
            <li>Automatic critical CSS: styled-component會紀錄有哪些元件被渲染到頁面上，並自動地載入所需要的樣式（也就是說不會載入多餘的東西）。</li>
            <li>No class name bugs: styled-component會為樣式產生unique的class name，所以我們不需要擔心style被複寫或者是拼寫錯誤。</li>
            <li>Easier deletion of CSS: 當我們在管理css的時候會發現確認一個class name到底有沒有被使用很麻煩，但使用styled-component就可以避免這個狀況，因為每個style都是緊密的跟著他所屬的component。</li>
            <li>Simple dynamic styling: 可以簡單並直覺地透過props或者是global主題來決定component的style。</li>
            <li>Painless maintenance: 不需要從多份CSS file管理component的樣式。</li>
            <li>Automatic vendor prefixing: styled=component幫我們處理了各種瀏覽器的css前綴(-webkit-/-moz-/-o-/-ms-)我們只需要寫標準的css寫法就好了。</li>
          </ol>
          <hr />
          以下是我個人對styled-component的看法：<br/>
          <ol>
            <li>
              方便：開發React的人一定會不斷地把大component切分成數個小component，
            ...
            <li>
              一目了然：平常我們定義一個css class name後，我們的tag會這樣寫–
